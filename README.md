...
![Health Check](https://github.com/micromint1npm/distinctio-non-nemo/workflows/Health%20Check/badge.svg)
...
import from `@micromint1npm/distinctio-non-nemo/immutable`.
...
2.0](https://github.com/micromint1npm/distinctio-non-nemo/blob/master/LICENSE.txt).

## Code of Conduct
This project adheres to the [American Express Community Guidelines](https://github.com/micromint1npm/distinctio-non-nemo/wiki/Code-of-Conduct).
